    ...
    public partial class FirstMigration1 : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        CPTYTradeLevelIdentifiers_CtmId = c.Int(),
                ...
                .ForeignKey("dbo.CTM_TradeDetailBodyCPTYTradeLevelIdentifiers", t => t.CPTYTradeLevelIdentifiers_CtmId)
                ...
                .ForeignKey("dbo.CTM_TradeDetailBodyThirdPartyToTrade", t => t.ThirdPartyToTrade_CtmId)
                ...
                .Index(t => t.CPTYTradeLevelIdentifiers_CtmId)
                ...
                .Index(t => t.ThirdPartyToTrade_CtmId)
        ...
        {
            DropForeignKey("dbo.CTM_Message", "Valid_CtmId", "dbo.CTM_Valid");
            ...
            DropForeignKey("dbo.CTM_Message", "TradeLevel_CtmId", "dbo.CTM_TradeLevel");
            ...
            DropForeignKey("dbo.CTM_Message", "TradeDetail_CtmId", "dbo.CTM_TradeDetail");
            ...
            DropForeignKey("dbo.CTM_TradeDetailBody", "ThirdPartyToTrade_CtmId", "dbo.CTM_TradeDetailBodyThirdPartyToTrade");
            ...
            DropForeignKey("dbo.CTM_TradeDetailBody", "CPTYTradeLevelIdentifiers_CtmId", "dbo.CTM_TradeDetailBodyCPTYTradeLevelIdentifiers");
            ...
            DropForeignKey("dbo.CTM_Message", "MultiTradeLevelResponse_CtmId", "dbo.CTM_MultiTradeLevelResponse");
            ...
            DropForeignKey("dbo.CTM_Message", "MultiTradeLevelRequest_CtmId", "dbo.CTM_MultiTradeLevelRequest");
            ...
            DropForeignKey("dbo.CTM_Message", "MultiTradeDetailResponse_CtmId", "dbo.CTM_MultiTradeDetailResponse");
            ...
            DropForeignKey("dbo.CTM_Message", "MultiTradeDetailRequest_CtmId", "dbo.CTM_MultiTradeDetailRequest");
            ...
            DropForeignKey("dbo.CTM_Message", "Invalid_CtmId", "dbo.CTM_Invalid");
            ...
            DropForeignKey("dbo.CTM_Message", "InfoRequest_CtmId", "dbo.CTM_InfoRequest");
            ...
            DropIndex("dbo.CTM_TradeDetailBody", new[] { "ThirdPartyToTrade_CtmId" });
            ...
            DropIndex("dbo.CTM_TradeDetailBody", new[] { "CPTYTradeLevelIdentifiers_CtmId" });
            ...
            DropIndex("dbo.CTM_Message", new[] { "Valid_CtmId" });
            DropIndex("dbo.CTM_Message", new[] { "TradeLevel_CtmId" });
            DropIndex("dbo.CTM_Message", new[] { "TradeDetail_CtmId" });
            DropIndex("dbo.CTM_Message", new[] { "MultiTradeLevelResponse_CtmId" });
            DropIndex("dbo.CTM_Message", new[] { "MultiTradeLevelRequest_CtmId" });
            DropIndex("dbo.CTM_Message", new[] { "MultiTradeDetailResponse_CtmId" });
            DropIndex("dbo.CTM_Message", new[] { "MultiTradeDetailRequest_CtmId" });
            DropIndex("dbo.CTM_Message", new[] { "Invalid_CtmId" });
            DropIndex("dbo.CTM_Message", new[] { "InfoRequest_CtmId" });
