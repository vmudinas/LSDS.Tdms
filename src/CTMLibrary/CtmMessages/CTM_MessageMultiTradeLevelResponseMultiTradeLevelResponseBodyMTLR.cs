...
namespace CTMLibrary.CtmMessages
{
    ...
    public partial class CTM_MessageMultiTradeLevelResponseMultiTradeLevelResponseBodyMTLR
    {
        ...
        private uint counterpartyCTMTradeSideIDField;
        ...
        /// <remarks/>
        public uint CounterpartyCTMTradeSideID
        {
            get
            {
                return this.counterpartyCTMTradeSideIDField;
            }
            set
            {
                this.counterpartyCTMTradeSideIDField = value;
            }
        }
